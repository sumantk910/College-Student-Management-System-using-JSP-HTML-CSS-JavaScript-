...
<title>DAVIET</title>
<body>
<img src="logou.png"  align="left"width="80" height="80">
<center><img src="logo-daviet.png" width="250" height="100">
<img src="images.jfif" align="right"  width="100" height="90"></center>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="AddResult.jsp" method="">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="chy">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="electrical_engg">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="electronic_engg">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="chy_lab">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="phy_lab">
                                    </div>
                                </div>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      try
      {
    	  ...
    	  ResultSet rs=st.executeQuery("select * from add_student");
    	  while(rs.next())
    	  { 
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      try
      {
    	  Connection con=SQL_Connection_Provider.getCon();
    	  Statement st=con.createStatement();
    	  ResultSet rs=st.executeQuery("select * from add_result");
    	  while(rs.next())
    	  { 
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact sumantk910@gmail.com.
Designed & Developed by @Ragnarork Team</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Ragnarork :: 2015-2020</h5></center> 
  <hr class="new1">
<br>
</body>
</html>