...
ResultSet rs=st.executeQuery(" select * from add_student inner join add_result where add_student.roll=add_result.roll and add_student.roll='"+roll+"' ");
if(rs.next())
{
%>


<img src="logou.png"  align="left"width="120" height="120">
<center><img src="logo-daviet.png" width="250" height="150">
<img src="images.jfif" align="right"  width="120" height="120"></center>
...
Designed & Developed by @Ragnarork Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Ragnarork :: 2015-2019</h6></center> 
  <hr class="new1">
</body>
<%}
else
